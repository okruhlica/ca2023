...
if __name__ == '__main__':
    ...
    avg_dummy = play_random_games(game_engine, ai_v1.RandomGuesser, CA2023_GAME_DEF, iterations=20)
    print(f"Average turns ({ai_v1.RandomGuesser.NAME}): {avg_dummy}")

    avg_stat = play_random_games(game_engine, ai_v2.StatisticalGuesser, CA2023_GAME_DEF, iterations=20)
